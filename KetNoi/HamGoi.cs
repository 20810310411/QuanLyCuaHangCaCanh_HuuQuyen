...
namespace QuanLyCuaHangCaCanh_KhacTu.KetNoi
{
    internal class HamGoi
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = "Data Source=DESKTOP-3CF995N\\SQLEXPRESS;Initial Catalog=QuanLyCuaHangBanCaCanh_KhacTu;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            dap.SelectCommand.Connection = HamGoi.Con; //Kết nối cơ sở dữ liệu
