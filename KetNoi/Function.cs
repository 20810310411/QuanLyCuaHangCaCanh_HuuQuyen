...
namespace QuanLyCuaHangCaCanh_HuuQuyen.KetNoi
{
    internal class Function
    {
        ...
        private string ConnectionString = "Data Source=DESKTOP-LGH1FNQ\\SQLEXPRESS;Initial Catalog=QuanLyCuaHangBanCaCanh;Integrated Security=True";
        ...
        //Lấy dữ liệu vào bảng
        public  DataTable GetDataToTable2(string sql)
        {
